...
const ms = {
    ...
    sheet: { width: '100%', maxWidth: '480px', maxHeight: '90vh', backgroundColor: '#fff', borderRadius: '20px 20px 0 0', display: 'flex', flexDirection: 'column', position: 'relative', animation: 'slideUp 0.3s ease' },
